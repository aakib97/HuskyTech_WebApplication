    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Shop Checklist</li>
            </ol>
                            ...
                            <form method="post">
                                <div class="card shadow py-lg-2 p-3">
                                    <div class="form-group">
                                        <h3 class="pb-2 border-bottom m-0 text-center">Shop Demonstration Sign-off
                                            <i class="fas fa-check" style="color:green; float:right;"></i>
                                        </h3>

                                        <br>

                                        <label for="checklistName">Your Name</label>
                                        <input type="text" class="form-control" id="checklistName" name="checklistName"
                                               value="<?php global $user;
                                               echo $user->Full ?>">
                                        <br>

                                        <label for="checklistRank">Rank</label>
                                        <select class="form-control" name="checklistRank" id="checklistRank" disabled>
                                        ...
                                        <input hidden id="checklistRank" name="checklistRank" value="<?php echo $user->Role;?>">

                                        <br>

                                        <label for="checklistTech">Tech Name</label>
                                        <input type="text" class="form-control" id="checklistTech" name="checklistTech"
                                               placeholder="Jonathan Husky">

                                        <label for="checklistDemos">Select demonstrations completed</label>
                                        <select multiple class="form-control" id="checklistDemos">
                                            <option>Software Install</option>
                                            <option>Ubuntu SMART Test</option>
                                            <option>MAC Reformat</option>
                                            <option>Windows Reformat</option>
                                        </select>

                                        <br>

                                        <label for="checklistComments">Additional Comments</label>
                                        <textarea class="form-control" id="checklistComments" rows="3"
