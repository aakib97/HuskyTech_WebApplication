...
if ($auth){
    ...
    } elseif ($user->Role != 'Trainee' && $user->Role != 'Shop Specialist'){
        ...
        <div class="container-fluid">
            ...
            <section>
                <div class="container-fluid">
                        ...
                        <div class="col">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h5 class="card-title"><span class="card-title">SHOP <?php echo ($user->Role == 'Trainee' ? 'BASIC ' : 'SPECIALIZED '); ?>TRAINING</h5>
                                </div>
                                <div class="card-body">
                    ...
                    <?php if ($user->Role == 'Trainee'): $training = $user->getTraining('Basic Training', 'Shop');
                                    ...
                                    <div class="card p-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 text-center pt-2">
                                                ...
                                                <?php $materials = $training->materals[$module->title];
                                            ...
                                            <div class="col-md-6 text-center pt-2">
                                                ...
                                                <?php $quizzes = $training->quizzes[$module->title];
                    ...
                    <?php if ($user->Role == 'Shop Specialist'): $training = $user->getTraining('Specialized Training', 'Shop');
                        foreach ($training->modules as $module):?>
                            <div class="row">
                                <div class="col">
                                    <div class="card p-3">
