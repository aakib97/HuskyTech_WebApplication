        ...
        <div class="container-fluid">
            ...
            <section>
                <div class="container-fluid">
                        ...
                        <div class="col">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h5 class="card-title"><span class="card-title">CALL CENTER <?php echo ($user->Role == 'Trainee' ? 'BASIC ' : 'SPECIALIZED '); ?>TRAINING</h5>
                                </div>
                                <div class="card-body">
                    ...
                    <?php if ($user->Role == 'Trainee'): $allMaterials= $user->getBasicModules('Call Center');
                    ...
                    <?php if ($user->Role == 'Specialized'): $allMaterials= $user->getSpecializedModules('Call Center');
                        foreach ($allMaterials->modules as $module):?>
                            <div class="row">
                                <div class="col">
                                    <div class="card p-3">
